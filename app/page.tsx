...
function FaqAccordion({
  ...
  return (
    <div className="border-b last:border-0 border-border/50">
      ...
      <div
        className={`overflow-hidden transition-colors duration-300 ${isOpen ? "max-h-40 pb-4 opacity-100" : "max-h-0 opacity-0"}`}
      >
    ...
    >
      ...
      <nav className="border-b sticky top-0 bg-background/80 backdrop-blur-md z-50 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div
            className="font-bold text-xl tracking-tight text-primary flex items-center gap-2 cursor-pointer"
          ...
          <div className="flex gap-4 items-center">
            <Link
              href="/dashboard"
              className="hidden sm:block text-sm font-medium text-muted-foreground hover:text-foreground transition-colors me-4"
            >
              لوحة التحكم
            </Link>
            <Button
              variant="default"
              className="shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-colors duration-200 rounded-full px-6"
      ...
      <main id="main-content">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-center lg:text-start z-10">
              <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium animate-fade-slide-up border border-primary/20">
                <Zap className="w-4 h-4" /> نظام ذكاء اصطناعي مخصص للعيادات
                السعودية
              </div>
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed animate-fade-slide-up animate-delay-2 text-balance">
                خلال 7 أيام نجهز لك نظام ذكي يدير العملاء، الحجوزات، التذكيرات،
                والتقارير من لوحة واحدة، لتركز على رعاية مرضاك.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-slide-up animate-delay-3">
                <Button
                  size="lg"
                  className="rounded-full px-8 h-14 text-lg shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-colors duration-200"
                  onClick={() => scrollToSection("pricing")}
                >
                  احجز ديمو مجاني
                </Button>
                <Link href="/dashboard">
                  <Button
                    size="lg"
                    variant="outline"
                    className="rounded-full px-8 h-14 text-lg border-2 hover:bg-muted transition-colors duration-200 w-full sm:w-auto"
                  >
                    جرب النظام الآن
                  </Button>
                </Link>
                ...
                <div className="bg-muted px-4 py-3 border-b flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground flex items-center gap-1">
                      <span className="w-2 h-2 rounded-full bg-success block"></span>{" "}
                      متصل الآن
                    </div>
                  </div>
                </div>
                <div className="p-4 space-y-4 bg-[url('/bg-pattern.svg')] bg-opacity-5">
                  ...
                  <div className="flex gap-2 w-full max-w-[85%] ms-auto justify-end">
                    <div className="bg-primary text-primary-foreground p-3 rounded-2xl rounded-tl-sm text-sm shadow-md">
                      وعليكم السلام! سعر تنظيف الأسنان 250 ريال.
                      <br />
                      <br />
                      نعم، يوجد موعد متاح اليوم الساعة 4:00 مساءً مع د. ريم. هل
                      أؤكد لك الحجز؟
                    </div>
                  </div>
                  <div className="flex gap-2 w-full max-w-[85%] me-auto">
                  ...
                  <div className="flex gap-2 w-full max-w-[85%] ms-auto justify-end">
                    <div className="bg-primary text-primary-foreground p-3 rounded-2xl rounded-tl-sm text-sm shadow-md">
                      ...
                      الموعد: اليوم الساعة 4:00 مساءً.
                      <br />
                      سنرسل لك تذكيراً قبل الموعد. نتمنى لك دوام الصحة!
                    </div>
                  </div>
                </div>
              </Card>
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold animate-fade-slide-up tracking-tight">
              كيف يعمل النظام؟
            </h2>
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              ثلاث خطوات بسيطة لأتمتة عيادتك بالكامل.
            </p>
          </div>
          ...
          <div className="relative grid md:grid-cols-3 gap-12">
            ...
            {[
              {
                num: "1",
                title: "العميل يرسل واتساب",
                desc: "يستقبل النظام استفسارات العملاء على رقم الواتساب الرسمي للعيادة.",
                icon: MessageCircle,
              },
              {
                num: "2",
                title: "الذكاء الاصطناعي يفهم ويرد",
                desc: "يحلل الـ AI الطلب ويرد بالإجابة أو يعرض المواعيد المتاحة فوراً.",
                icon: Bot,
              },
              {
                num: "3",
                title: "الحجز يتأكد والتذكير يُرسل",
                desc: "يُسجل الحجز في لوحة التحكم وتُجدول رسائل التذكير آلياً.",
                icon: Calendar,
              },
            ].map((step, index) => (
              <div
        ...
        <LandingSection
          maxWidth="5xl"
          containerClassName="text-center space-y-12"
        >
          <div className="space-y-4">
            <h2 className="text-3xl font-bold animate-fade-slide-up tracking-tight">
              التحديات التي نواجهها في العيادات
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              نحن نفهم معاناتك اليومية مع إدارة المواعيد والردود.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                title: "غرق في واتساب",
                desc: "موظف الاستقبال يقضي 70% من وقته يجاوب نفس الأسئلة مراراً",
                icon: MessageCircle,
                color: "text-brand",
                bg: "bg-brand/10",
              },
              {
                title: "حجوزات فائتة",
                desc: "عملاء يسألون عن الأسعار والمواعيد ثم يختفون لعدم متابعتهم",
                icon: Calendar,
                color: "text-warning",
                bg: "bg-warning/10",
              },
              {
                title: "لا رؤية واضحة",
                desc: "بدون بيانات يصعب معرفة ما يعمل وما لا يعمل في العيادة",
                icon: BarChart3,
              ...
              <Card
                key={p.title}
                className="text-start border-none bg-muted/40 shadow-none hover:bg-muted/80 transition-colors duration-300"
              >
                <CardContent className="p-8 space-y-4">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center ${p.bg}`}
                  >
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              منصة متكاملة تدير كل تفاصيل علاقتك مع المراجعين.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f) => (
              <Card
                key={f.title}
                className="group hover:border-primary/50 transition-colors duration-300 hover:shadow-md bg-background"
              >
        ...
        <LandingSection id="pricing" maxWidth="6xl" background="muted">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold animate-fade-slide-up tracking-tight">
              باقات تناسب نمو عيادتك
            </h2>
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              اختر الباقة المناسبة لك، ويمكنك الترقية في أي وقت.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 items-start lg:px-12">
            {PRICING.map((p) => (
              <Card
                key={p.name}
                className={`relative transition-colors duration-300 ${p.highlight ? "border-primary shadow-2xl scale-105 z-10" : "border-border/50 shadow-sm hover:shadow-md mt-0 md:mt-4"}`}
              >
                {p.highlight && (
                  <div className="absolute top-0 inset-x-0 -translate-y-1/2 flex justify-center">
                    <span className="bg-primary text-primary-foreground text-xs px-4 py-1.5 rounded-full font-bold uppercase tracking-wider shadow-sm">
                      الأكثر شيوعاً
                    </span>
                  </div>
                )}
                <CardContent className="p-8 space-y-8">
                  ...
                  <Button
                    className="w-full rounded-full h-12 text-md shadow-sm hover:shadow-md transition-colors duration-200"
        ...
        >
          ...
          <div className="text-center space-y-8 relative z-10 py-24">
            <h2 className="text-4xl font-extrabold text-primary-foreground tracking-tight text-balance">
              مستعد لتغيير طريقة عمل عيادتك؟
            </h2>
            <p className="text-primary-foreground/80 text-xl max-w-2xl mx-auto leading-relaxed text-balance">
              لا تحتاج لبطاقة ائتمانية. شاهد النظام وهو يعمل بشكل حي في أقل من 5
              دقائق.
            </p>
            <div className="flex justify-center pt-4">
              <Link href="/dashboard">
                <Button
                  size="lg"
                  variant="secondary"
                  className="rounded-full px-10 h-16 text-lg font-bold shadow-xl hover:shadow-2xl hover:scale-105 transition-colors duration-300 gap-2"
                >
            ...
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              <div className="md:col-span-2 space-y-4">
                ...
                <p className="text-muted-foreground text-sm max-w-sm leading-relaxed">
                  النظام الذكي الأول في المملكة لإدارة العيادات عبر الواتساب.
                  مصمم خصيصاً ليناسب احتياجات العيادات السعودية.
                </p>
              </div>
              <div>
