...
import { FEATURES, PRICING, FAQS } from "./content";

const iconMap: Record<string, React.ElementType> = { MessageCircle, Calendar, Bell, BarChart3, Users, Bot };
      ...
      <main id="main-content">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURES.map((f) => {
              const Icon = iconMap[f.iconKey] || Check;
              return (
              <Card
                key={f.title}
